...
//Header kép szöveg és gomb
$lang['CHEMCORE_TEXT'] = "Cégünk küldetése partnereink igényeit kiszolgálni,<br>igazodva az egyre magasabb elvárásokhoz,<br>folyamatosan bővülő termékválasztékkal<br>és versenyképes árakkal.";
$lang['CHEMCORE_BUTTON'] = "TERMÉKEINK";
//-----//

//Rólunk
$lang['ABOUT_US'] = "Rólunk";
$lang['ABOUT_US_TEXT'] = "Cégünk egy dinamikusan fejlődő, hazai tulajdonban lévő vállalkozás.<br>
                          Háztartási-Vegyipari termékek gyártásával és forgalmazásával foglalkozunk. Számos multinacionális vállalat sajátmárkás termékeit forgalmazzuk a saját márkáink mellett.<br><br> 
                          Jelen vagyunk Szlovákiában, Csehországban, Lengyelországban, Magyarországon, Dániában, Németországban és Svédországban.<br>";
$lang['ABOUT_US_TESCO'] = "Cégünk egyéb területen 4 országos Tesco PL beszállító.";
//-----//

//Háztartási rész
$lang['USAGE_TITLE'] = "háztartási-vegyipari termékek";
$lang['USAGE_BOX_TITLE_1'] = "számos használatra";
$lang['USAGE_BOX_TEXT_1'] = "A tisztítás, takarítás és higiénia számos területét felölelő termékkínálat.";
...
$lang['USAGE_BOX_TEXT_3'] = "Magas használati érték, bőséges kínálat, széles választék.";
//-----//

//SECTION LILY
$lang['LILY_TITLE'] = "lily termékcsalád";
$lang['LILY_TEXT_1'] = "A Lily termékcsalád a textíliák megfelelő tisztítását, mosását, egyéb elő-és utókezelését biztosító termékeket tartalmaz (áztatástól, mosáson át- folyékony mosószerrel, kapszulált mosógéllel, mosóporral, egészen a kimagasló minőségű szálpuhításig). Prémium minőségű termékek tartoznak ebbe a katergóriába. Magas minőségű piacvezető mosószerek alapján lettek kifejlesztve, figyelve maradéktalanul a vásárlói elvárásokra.";
$lang['LILY_TEXT_2'] = "A mosó-és tisztítószerek magas koncentrációban felületaktív anyagokat, enzimeket, különböző gondosan összeválogatott mosó-és tisztítóhatást fokozó adalékanyagot  (szálpuhító, optikai fehérítő, színvédő, klórmentes konzerváló, oxigénes fehérítő) és magas minőségű illatanyagokat tartalmaznak.";
$lang['LILY_TEXT_3'] = "Mosó-és tisztítószereink összetételüket, csomagolásukat és a szükséges termék dokumentációt tekintve, úgy lettek kialakítva, hogy a mindenkori, érvényben lévő hazai-és nemzetközi  jogszabályoknak megfeleljenek.";
$lang['LILY_BUTTON'] = "Tovább";
//-----//

//SECTION SCUDO
$lang['SCUDO_TITLE'] = "scudo termékcsalád";
$lang['SCUDO_TEXT_1'] = "A Scudo termékcsalád, megfelelő árért, megfelelő minőségű tisztítást garantál a háztartás egész területén, a konyhától a nappalin keresztül a fürdőszobáig.";
$lang['SCUDO_TEXT_2'] = "A termékek minőségi alapanyagokat tartalmaznak a megfelelő hatás elérése érdekében. Praktikus megoldást jelentenek a háztartás bármely területén. A termékpaletta úgy lett kifejlesztve/összeállítva, hogy az otthonok minden területét tisztán tarthassák a termékcsalád tagjainak használatával (pl. vízlágyítótól a fa-és bútorápolón keresztül a mosogatószerig).";
$lang['SCUDO_TEXT_3'] = "A mosó-és tisztítószerek felületaktív anyagokat, enzimeket, különböző gondosan összeválogatott mosó-és tisztítóhatást fokozó adalékanyagot tartalmaznak.";
$lang['SCUDO_BUTTON'] = "Tovább";
//-----//

//SECTION CONTACT
$lang['CONTACT_TITLE'] = "Kapcsolat";
$lang['CONTACT_MOBILE'] = "Telefon";
$lang['CONTACT_FORM_NAME'] = "Név";
$lang['CONTACT_FORM_MESSAGE'] = "Üzenet";
$lang['CONTACT_FORM_BUTTON'] = "Küldés";
$lang['MESSAGE_SUCCESS'] ="Az E-mail küldésre került! ";
$lang['MESSAGE_REST'] ="Köszönjük, amint tudunk kapcsoaltba lépünk önnel.";
//-----//
...
//PAGE LILY
    ...
    $lang['LILY_ITEM_NAME_1_INGR'] = "Glycereth-6 Cocoate, Glycerin, Cocamide MEA, Aqua, Polyvinyl Alcohol MIPA Laureth Sulfate, PEG-4 Rapeseedamide Sodium diethylenetriamine pentamethylene phosphonat, Perfume, 		Propylene Glycol, Colorant, PVP, Sodium Formate, Enzyme -Subtilisin, Denatonium Benzoate";
...
Disodium 2,2'-([1,1'-biphenyl]- 4,4'diyldivinylene)bis(benzenesulphonate)";
    ...
    $lang['LILY_ITEM_3_SPECS'] = "1,5l/3l/4,5l";
...
Coloring agent";
    ...
    $lang['LILY_ITEM_4_SPECS'] = "1,5l/3l/4,5l";
...
//PAGE SCUDO
    $lang['SCUDO_TITLE_1'] = "scudo mosógélek";
        ...
        $lang['SCUDO_ITEM_1_SPECS'] = "1,5l / 3l /4,5l";
...
Enzymes (Protease) Hydroxyethyl cellulose 1,2- Benzizotiazolin-3-one Perfume Coloring agent";
        ...
        $lang['SCUDO_ITEM_2_SPECS'] = "1,5l / 3l /4,5l";
...
//Terméknézet
    ...
    $lang['PRODUCT_PAGE_INCI'] = "Minden összetevő az INCI nevével van feltüntetve (International Nomenclature of Cosmetic Ingredients = A Kozmetikai Összetevők Internacionális Nómenklatúrája), vagy ha INCI neve nincs az összetevőnek, akkor a nemzetközileg elfogadott kémiai nevével van megadva. INCI";
